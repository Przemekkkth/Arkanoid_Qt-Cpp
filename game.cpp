...
const int Game::DEATH_Y_LEVEL = 550;
Game::Game()
    : RESOLUTION(QSize(520, 450)), PATH_TO_BACKGROUND_PIXMAP(":/images/background.png"),
      ...
      PATH_TO_VICTORY_BG_PIXMAP(":/images/bg_victory.png"),
      ITERATION_VALUE(1000.0f/60.0f), PADDLE_SPEED(16), m_isBallStucked(true), m_deltaX(5),
      m_deltaY(-6), m_state(State::Active)
{
